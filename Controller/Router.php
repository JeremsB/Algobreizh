...
require_once 'Controller/ControleurMagasin.php';
require_once 'Controller/ControleurArticle.php';
require_once 'Controller/ControleurClient.php';
require_once 'Controller/ControleurCommande.php';
    ...
    public function routerRequete() {
        ...
        try {
            ...
            if (isset($_GET['page'])) { //Dirige vers les pages, ex: envoie sur la page inscription mais n'inscrit pas contrairement a action = inscription
                ...
                if($_GET['page'] ==  'inscription'){
                    ...
                    if (isset($_SESSION['client'])){
                        ...
                        require 'Vue/vueCommandesCl.php';
                    }
                    else {
                      require "Vue/vueConnexion.php";
                    }
			...
			$nom = htmlspecialchars($this->getParametre($_POST, "nom"));
                ...
                else if($_GET["action"] == "creerFacture"){

                            $idCommande = $this->getParametre($_GET, 'idCommande');
                            $this->ctrlCommande->creerFacture($idCommande);
